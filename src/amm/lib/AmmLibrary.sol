...
library AmmLibrary {
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"a700b84dfe8b00a3d1990239937527a5c0155f6733feeda4b69d979b100d0738" // init code hash
                        )
                    )
                )
            )
    ...
    function getAmountOut(
        ...
        uint256 amountInWithFee = amountIn.mul(10000);
    ...
    function getAmountIn(
        ...
        uint256 denominator = reserveOut.sub(amountOut).mul(10000);
